				...
				<form action="" method="post" class="contact-form bg-white">
					...
					<div class="row">
						<div class="col-lg-6 form-group">
							<h6>Nome</h6>
							<input type="text" class="form-control" name="nome" placeholder="Nome" value="{$C.nome}" autocomplete="off" required>
						</div>
						<div class="col-lg-6 form-group">
							<h6>Sigla</h6>
							<input type="text" class="form-control" name="sigla" placeholder="Sigla" value="{$C.sigla}" autocomplete="off" required>
						</div>
					</div>

					<div class="form-group">
						<h6>Fundamentação Legal</h6>
						<textarea class="form-control" name="fundamentacao" placeholder="Fundamentação Legal">{$C.fundamentacao}</textarea>
					</div>

					<div class="form-group">
						<h6>Requisitos</h6>
						<textarea class="form-control" name="requisito" placeholder="Requisitos">{$C.requisito}</textarea>
					</div>

					<input class="form-control" type="hidden" name="id" value="{$C.id}">
