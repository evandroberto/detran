...
<head>
	...
	<!-- ====== Favicon ====== -->
	<link rel="shortcut icon" type="image/png" href="{$GET_TEMPLATE}/template/images/favicon.png">
	...
	<link rel="stylesheet" href="{$GET_TEMPLATE}/template/js/sweetalert/sweetalert2.css">
	<script src="{$GET_TEMPLATE}/template/js/sweetalert/sweetalert2.all.min.js"></script>
...
<body data-spy="scroll" data-target=".navbar-nav">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="{$PAG_AVALIACOES}">ACOMPANHAMENTO</a></li>
						<li class="nav-item"><a class="nav-link" href="{$PAG_AVALIACOES}">RELATÓRIOS</a></li>
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="{$PAG_AVALIACOES}">AVALIAÇÕES</a>
								<a class="dropdown-item" href="{$PAG_COMPETENCIAS}">COMPETÊNCIAS</a>
								<a class="dropdown-item" href="{$PAG_CURSOS}">CURSOS</a>
								<a class="dropdown-item" href="{$PAG_DISCIPLINAS}">DISCIPLINAS</a>
								<a class="dropdown-item" href="{$PAG_MATRIZES}">MATRIZES</a>
								<a class="dropdown-item" href="{$PAG_PERFIS}">PERFIS</a>
							</div>
						</li>
					</ul>
				</div>
	...
	<!-- ====== ALL JS ====== -->
	<script src="{$GET_TEMPLATE}/template/js/jquery-3.3.1.min.js"></script>
	<script src="{$GET_TEMPLATE}/template/js/sweetalert/sweetalert2.min.js"></script>
