<?php
/* Smarty version 3.1.33, created on 2019-01-06 00:10:52
  from 'C:\xampp\www\php7\adm\view\competencias\edicao.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c31397cb16e31_96129593',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9430a2add3050929885ba4bf1e149b0aeb15fa08' => 
    array (
      0 => 'C:\\xampp\\www\\php7\\adm\\view\\competencias\\edicao.tpl',
      1 => 1546729821,
      2 => 'file',
    ),
  ),
...
function content_5c31397cb16e31_96129593 (Smarty_Internal_Template $_smarty_tpl) {
?>	<!-- Page Title -->
...
?>
					<div class="row">
						<div class="col-lg-2 form-group">
							<h6>Código</h6>
							<input type="text" class="form-control" name="codigo" placeholder="Código" value="<?php echo $_smarty_tpl->tpl_vars['CP']->value['codigo'];?>
" autocomplete="off" required>
						</div>
						<div class="col-lg-10 form-group">
							<h6>Nome</h6>
							<input type="text" class="form-control" name="nome" placeholder="Nome" value="<?php echo $_smarty_tpl->tpl_vars['CP']->value['nome'];?>
" autocomplete="off" required>
						</div>
					</div>
...
" <?php if ($_smarty_tpl->tpl_vars['CP']->value['curso_id'] == $_smarty_tpl->tpl_vars['C']->value['id']) {?> selected <?php }?>><?php echo $_smarty_tpl->tpl_vars['C']->value['nome'];?>
</option>
							<?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
					...
					<input class="form-control" type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['CP']->value['id'];?>
">
