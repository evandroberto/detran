<?php
/* Smarty version 3.1.33, created on 2019-01-05 15:06:36
  from 'C:\xampp\www\php7\adm\view\cursos\lista.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5c30b9ec89ec20_77834314',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9e9421d82a6e92dd4268d595c39853d6298fbf7e' => 
    array (
      0 => 'C:\\xampp\\www\\php7\\adm\\view\\cursos\\lista.tpl',
      1 => 1546695696,
      2 => 'file',
    ),
  ),
...
function content_5c30b9ec89ec20_77834314 (Smarty_Internal_Template $_smarty_tpl) {
?>	<!-- Page Title -->
...
<section class="section-padding contact-section bg-light">
	<div class="container">
		...
		<div class="cta-button text-right">
			<a href="<?php echo $_smarty_tpl->tpl_vars['CURSO_CADASTRO']->value;?>
" class="button">Novo</a>
		</div>
...
" name="edicao" method="post" action="<?php echo $_smarty_tpl->tpl_vars['CURSO_EDICAO']->value;?>
" style="display:inline;">
							<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['C']->value['id'];?>
">

							<a href="javascript:void(0)" title="Editar" onclick="document.getElementById('edicao<?php echo $_smarty_tpl->tpl_vars['C']->value['id'];?>
').submit(); return false;"><i class="far fa-edit fa-lg"></i>&emsp;</a>
						</form>

						<form id="exclusao<?php echo $_smarty_tpl->tpl_vars['C']->value['id'];?>
" name="exclusao" method="post" action="<?php echo $_smarty_tpl->tpl_vars['CURSO_EXCLUSAO']->value;?>
" style="display:inline;">
							<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['C']->value['id'];?>
">
	...
	{	
		swal({
			...
			preConfirm: function() {
				...
				{
					$.ajax({
						url: '<?php echo $_smarty_tpl->tpl_vars['CURSO_EXCLUSAO']->value;?>
',
						type: 'POST',
						data: 'id='+id,
						dataType: 'html'
